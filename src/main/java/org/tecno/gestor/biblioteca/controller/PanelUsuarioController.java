...
public class PanelUsuarioController {
    ...
    public void VentanaModal() {
        ...
        adminModal.mostrarModal("Registrar usuario", controller -> {
            ...
            controller.setRolUsuarioLogueado(rolUsuarioActual);  // Pasar rol del usuario logueado
        });
        CargarDatosEnTabla();
    }
    ...
    public void VentanaModal(Cuenta cuenta) {
        ...
        adminModal.mostrarModal("Editar usuario", controller -> {
            ...
            controller.setRolUsuarioLogueado(rolUsuarioActual);
        });
        CargarDatosEnTabla();
    }
...
//    }
    ...
    public void CargarDatosEnTabla() {
        cuentas.clear();
        if (rolUsuarioActual == TipoCuenta.ADMINISTRADOR) {
            cuentas.addAll(ls.Encontrar_Cuentas());
        } else if (rolUsuarioActual == TipoCuenta.BIBLIOTECARIO) {
            cuentas.addAll(ls.Encontrar_Cuenta_por_Tipo(TipoCuenta.USUARIO));
        }
        TablaUsuarios.setItems(FiltroDatos);
    }
